...
namespace FluentDicovery.ServiceDiscovery
{
    public static class ApplicationBuilderExtensions
    {
        public static IApplicationBuilder UseServiceDiscovery(this IApplicationBuilder app)
        {
            ...
            var serviceOptions = app.ApplicationServices.GetRequiredService<IOptions<ServiceDisvoveryOptions>>() 
                ?? throw new ArgumentException("Missing dependency", nameof(IOptions<ServiceDisvoveryOptions>));
